...
- **Comments**: Add comments to the code. These comments will be read by future developers and by agents
    - Comment class and function/method definitions
    - Comments should describe *what* the code does not how it does it
